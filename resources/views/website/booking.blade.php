            ...
            <div class="col-md-8">
                <form method="post" action="{{url('booking')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="form-text">Dies ist die deinem Account zugeordnete E-Mail Adresse.
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Datum Anreise</label>
                        <input name="arrivingdate" type="date" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Datum Abreise</label>
                        <input name="departuredate" type="date" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-1 mt-4">
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">Nach Absenden dieser Anfrage bestätigen wir
                            Ihre Buchung innerhalb von 24 Stunden.</label>
                    </div>
